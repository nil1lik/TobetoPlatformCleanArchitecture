...
public static class ApplicationServiceRegistration
{
    public static IServiceCollection AddApplicationServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IProfileApplicationStepsService, ProfileApplicationStepsManager>();
        services.AddScoped<IEducationPathsService, EducationPathsManager>();
        services.AddScoped<IVideoDetailSubcategoriesService, VideoDetailSubcategoriesManager>();
        services.AddScoped<IVideoLanguagesService, VideoLanguagesManager>();
        services.AddScoped<IUserApplicationsService, UserApplicationsManager>();
        ...
        services.AddScoped<IVideoCategoriesService, VideoCategoriesManager>();
        services.AddScoped<ISocialMediaAccountsService, SocialMediaAccountsManager>();
        services.AddScoped<ISocialMediaCategoriesService, SocialMediaCategoriesManager>();
        return services;
    }
